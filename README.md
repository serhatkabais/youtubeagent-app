...
- `data/`
  - `ozan_sihay_yorumlar.json` : Ozan Sihay kanalı için derlenmiş örnek yorum veri seti.
  - `erhan_meydan_yorumlar.json` : Erhan Meydan kanalı için derlenmiş örnek yorum veri seti.
- `prompts/`
...
* **Ajan Çıktısı:**
  - **Saptanan İklim Türü:** `Teknik & Otomasyon Odaklı Topluluk`
